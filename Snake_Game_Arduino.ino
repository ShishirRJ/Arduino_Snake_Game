...
int snakeSpeed, intSnakeSpeed;

void setup()
{
  intAllDevices();              //Line 74
  intSnakePosn();               //Line 38
  foodPosn();                   //Line 157
  Serial.begin(9600);           
  refresh();                    //Line 301
...
void controlSnakeSpeed()
{
  ...
  intSnakeSpeed= map(level, 1, 10, 600, 100);
}
...
{
  if (score>15)
  snakeSpeed=intSnakeSpeed*0.6;
  else if (score>12)
  snakeSpeed=intSnakeSpeed*0.7;
  else if (score>8)
  snakeSpeed=intSnakeSpeed*0.8;
  else if (score>4)
  snakeSpeed=intSnakeSpeed*0.9;
  else
  snakeSpeed=intSnakeSpeed;
}
